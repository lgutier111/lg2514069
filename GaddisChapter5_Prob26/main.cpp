 ...
 * Gaddis 7th Edition Chapter 5 Problem 26
 ...
 *
 * MODIFY for problem 26 - write the final report to a file
 * 
...
int main(int argc, char** argv) {
    ...
    if (balance < 0)
    {
        ...
        cout << "There will be no report to generate\n";
    }
    else
    {
        ...
        cout << setw(35) << "The total amount of interest: $" << 
                setw(8) << accumI << endl;
        cout << "\nThis report has been written out to a file.";
        
        //Write the same report out to a file
        // NOTE: When the report is opened in NOTEPAD, it is strung across one
        //       line with the carriage return after each line.  In WORDPAD,
        //       the report looks like it should.
        outFile1 << setw(35) << "The balance on the account: $" << 
                setw(8) << balance << endl;
        outFile1 << setw(35) << "The total amount of deposits: $" << 
                setw(8) << accumD << endl;
        outFile1 << setw(35) << "The total amount of withdrawals: $" << 
                setw(8) << accumW << endl;
        outFile1 << setw(35) << "The total amount of interest: $" << 
                setw(8) << accumI << endl;
